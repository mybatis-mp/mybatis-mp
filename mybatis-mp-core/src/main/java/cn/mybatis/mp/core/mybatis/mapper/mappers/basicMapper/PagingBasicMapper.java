...
public interface PagingBasicMapper extends BaseMapper, BaseBasicMapper {
    ...
    default <T, P extends Pager<T>> P paging(Class<T> entityType, P pager, Consumer<Where> consumer) {
        return this.paging(entityType, pager, consumer, null);
    }
    ...
    default <T, P extends Pager<T>> P paging(Class<T> entityType, P pager, Where where) {
        return this.paging(entityType, pager, where, null);
    }
