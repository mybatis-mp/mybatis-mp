...
public interface IOrderByDatasetGetterFunctionMethod<SELF extends IOrderByDatasetGetterFunctionMethod> extends IBaseOrderByMethods,IOrderByDatasetGetterFunMethod<SELF> {
    ...
    default <T, DATASET extends IDataset<DATASET, DATASET_FIELD>, DATASET_FIELD extends IDatasetField<DATASET_FIELD>> SELF orderBy(IDataset<DATASET, DATASET_FIELD> dataset, IOrderByDirection orderByDirection, Getter<T> column, Function<DATASET_FIELD, Cmd> f){
